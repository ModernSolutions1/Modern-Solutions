    ...
    <section class="product-table">
            ...
            <div class="sub-header">
                <div class="filter-sort">
                    <div class="div1">
                        ...
                        <button class="custom-border"><i class="fa-solid fa-filter"></i></button>
                    </div>
                    </form>
                    <div class="div1">
                        <?php
                ...
                <div class="srch">
                    <div class="search-group">                       
                        <input type="search" name="search" placeholder="Search here..." class="custom-border">
        ...
        <section class="all-products">
            ...
            if (isset($_GET['showcase_id'])) {
                ...
                $mysql = "SELECT * FROM tbl_products WHERE category_id=$showcase_id and active='Yes' LIMIT 60";
                $mysql_res = mysqli_query($conn, $mysql);
                $_SESSION['show_count'] = mysqli_num_rows($mysql_res);
            } elseif (isset($_GET['featured'])) {

                if (!isset($_GET['filter_category'])) {
                    $mysql = "SELECT * FROM tbl_products WHERE featured='Yes' and active='Yes' LIMIT 60";
                } else {
                    if ($_GET['filter_category'] != 0) {
                        $selected_val = $_GET['filter_category'];
                        $mysql = "SELECT * FROM tbl_products WHERE category_id=$selected_val and active='Yes' LIMIT 60";
                    } else {
                        if ($_GET['filter_category'] == 0) {
                            $mysql = "SELECT * FROM tbl_products WHERE featured='Yes' and active='Yes' LIMIT 60";
                            $mysql_res = mysqli_query($conn, $mysql);
            ...
            elseif (isset($_GET['search'])) {
                ...
                $mysql = "SELECT * FROM tbl_products WHERE product_name LIKE '%$search_val%' AND active='Yes' LIMIT 60";
                $mysql_res = mysqli_query($conn, $mysql);
            }else {

                if (!isset($_GET['filter_category'])) {
                    $mysql = "SELECT * FROM tbl_products WHERE active='Yes' LIMIT 60";
                } else {
            ...
            // $number_of_results = mysqli_num_rows($mysql_res);
            ...
            ?>
                    <div class="p_container">
                        ...
                        <div class="p_desc" style="color:#555">
